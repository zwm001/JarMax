...
public class Zjdr extends Spider {
    ...
    private Pattern regexPage = Pattern.compile("/vodshow/id/(\\S+).html");

    @Override
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"XRJX\":{\"show\":\"追剧专享\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"xinluan\":{\"show\":\"备用专享\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"tpm3u8\":{\"show\":\"卡就换源\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"qq\":{\"show\":\"腾讯\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"qiyi\":{\"show\":\"奇艺视频\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"youku\":{\"show\":\"优酷\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"mgtv\":{\"show\":\"芒果\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"fsm3u8\":{\"show\":\"备用线路二\",\"des\":\"\",\"ps\":\"0\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"hnm3u8\":{\"show\":\"备用线路三\",\"des\":\"\",\"ps\":\"0\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"ukm3u8\":{\"show\":\"备用线路四\",\"des\":\"\",\"ps\":\"0\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"tkm3u8\":{\"show\":\"备用线路(可换源)\",\"des\":\"\",\"ps\":\"0\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"if101\":{\"show\":\"海外华人专用(国内翻墙)\",\"des\":\"\",\"ps\":\"0\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"}}");
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) {
        try {
            ...
            int page = -1;
            // 取页码相关信息
            Elements pageInfo = doc.select("ul[id=page]");
            if (pageInfo.size() == 0) {
                ...
                for (int i = 0; i < pageInfo.size(); i++) {
                    ...
                    if (a == null)
                        continue;
                    String name = a.text();
                    if (page == -1 && li.hasClass("span.page-current")) {
